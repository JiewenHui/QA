...
import time
import datetime
from helper_my import load_wiki,get_overlap_dict, batch_gen_with_point_wise, load, prepare, batch_gen_with_single,test_my
import operator
# from QA_CNN_point import QA_quantum as model
from CNNQLM_II_flat import CNN as model
# from vocab import CNN as model
# from dim   import CNN as model
# from CNNQLM_I   import CNN as model
import random
import evaluation
import pickle
import config
